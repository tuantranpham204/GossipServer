...
Rails.application.configure do
  ...
  # REQUIRED for Active Storage url_for
  config.action_controller.default_url_options = { host: "#{ENV["HOST"]}:#{ENV["PORT"]}" }

  # If you are using 'rails_blob_url' explicitly, you might also need this:
