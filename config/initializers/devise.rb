...
Devise.setup do |config|
  ...
  # config.secret_key = '3d9114c7eab7ca7f5093d224889a8c6ff79bb07279dca064ff5d21c2a8ca0f90ab242f792961179d41f3e35847644aa227cffc98ad9ee8b3744afb36b593009f'
  ...
  # config.pepper = 'a2aff9c1f58c1927380e3f36e17ac2f83a2bd689813ea034b82f5537aa33aeb051643668f8e2fa13974347f95da61851b2d9c4684a236ccc342c7d2651515363'
  ...
  config.jwt do |jwt|
    ...
    jwt.expiration_time = ENV.fetch("SYSTEM_JWT_EXPIRATION_HOURS", 24).to_i.hours
  end
end
